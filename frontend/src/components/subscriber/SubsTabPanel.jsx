...
export default function SubsTabPanel({ rowData }) {
    ...
    const TabPanelItems = useMemo(() => ([
        ...
        { label: "کارتابل تیکت ها", component: <SubscriberTicketsTable subsData={ticketsProp} /> },
    ]))

    const handleChange = (_, newValue) => setValue(newValue)

    return (
        <Box width="95%" border="1px solid #fff" p={1} mt={3} borderRadius={1}>
